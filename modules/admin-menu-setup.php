...
add_action( 'admin_action_pwd_maintenance_on', 'pwd_maintenance_on_admin_action' );
add_action( 'admin_action_pwd_maintenance_off', 'pwd_maintenance_off_admin_action' );
